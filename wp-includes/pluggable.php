...
function wp_mail( $to, $subject, $message, $headers = '', $attachments = array() ) {
	...
	/* If we don't have an email from the input headers default to eddcoons_portfolio@$sitename
	...
	if ( !isset( $from_email ) ) {
		...
		$from_email = 'eddcoons_portfolio@' . $sitename;
	}
...
function wp_notify_postauthor( $comment_id, $deprecated = null ) {
	...
	$wp_email = 'eddcoons_portfolio@' . preg_replace('#^www\.#', '', strtolower($_SERVER['SERVER_NAME']));
