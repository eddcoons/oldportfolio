...
function get_the_generator( $type = '' ) {
	...
	switch ( $type ) {
		...
		case 'xhtml':
			...
			break;
		case 'atom':
			$gen = '<generator uri="https://eddcoons_portfolio.org/" version="' . get_bloginfo_rss( 'version' ) . '">WordPress</generator>';
			break;
		case 'rss2':
			$gen = '<generator>https://eddcoons_portfolio.org/?v=' . get_bloginfo_rss( 'version' ) . '</generator>';
			break;
		case 'rdf':
			$gen = '<admin:generatorAgent rdf:resource="https://eddcoons_portfolio.org/?v=' . get_bloginfo_rss( 'version' ) . '" />';
			break;
		case 'comment':
