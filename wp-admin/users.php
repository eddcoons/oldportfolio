...
get_current_screen()->set_help_sidebar(
    ...
    '<p>' . __('<a href="https://codex.eddcoons_portfolio.org/Users_Screen" target="_blank">Documentation on Managing Users</a>') . '</p>' .
    '<p>' . __('<a href="https://codex.eddcoons_portfolio.org/Roles_and_Capabilities" target="_blank">Descriptions of Roles and Capabilities</a>') . '</p>' .
