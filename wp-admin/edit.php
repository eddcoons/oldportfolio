...
if ( 'post' == $post_type ) {
	...
	'<p>' . __('<a href="https://codex.eddcoons_portfolio.org/Posts_Screen" target="_blank">Documentation on Managing Posts</a>') . '</p>' .
	...
	get_current_screen()->set_help_sidebar(
	'<p><strong>' . __('For more information:') . '</strong></p>' .
	'<p>' . __('<a href="https://codex.eddcoons_portfolio.org/Pages_Screen" target="_blank">Documentation on Managing Pages</a>') . '</p>' .
	'<p>' . __('<a href="https://eddcoons_portfolio.org/support/" target="_blank">Support Forums</a>') . '</p>'
	);
