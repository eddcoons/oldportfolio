...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="https://codex.eddcoons_portfolio.org/Network_Admin_Sites_Screen" target="_blank">Documentation on Site Management</a>') . '</p>' .
	'<p>' . __('<a href="https://eddcoons_portfolio.org/support/forum/multisite/" target="_blank">Support Forums</a>') . '</p>'
);
