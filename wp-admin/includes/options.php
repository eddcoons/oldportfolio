...
function options_reading_blog_charset() {
	...
	echo '<p class="description">' . __( 'The <a href="https://codex.eddcoons_portfolio.org/Glossary#Character_set">character encoding</a> of your site (UTF-8 is recommended)' ) . '</p>';
}
