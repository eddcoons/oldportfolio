...
?>
							...
							<span class="one-third-container" style="text-align:center">
								...
								<span class="description" style="text-align:center;min-height:60px;"><?php _e("There are several ways to add your slider to your eddcoons_portfolio post / page / etc.", 'revslider');?></span>
								<div style="float:none; clear:both; height:20px;"></div>
					...
					<div class="setting_box" id="phandlings">
						...
						<div class="inside" style="display:none;">
							...
							<div id="problem-troubleshooting" style="display:none;">
								...
								<div id="label_output_type" class="label" origtitle="<?php _e("Activate a protection against eddcoons_portfolio output filters that adds html blocks to the shortcode output like P and BR.", 'revslider');?>"><?php _e("Output Filters Protection", 'revslider');?> </div>
